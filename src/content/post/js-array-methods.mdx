...
author: "Feridum"
image: "/assets/images/js-array-methods/logo.jpg"
...
```
![map simple](/assets/images/js-array-methods/map-simple.png)
...
```
![map moment](/assets/images/js-array-methods/map-moment.png)
...
```
![reduce single](/assets/images/js-array-methods/reduce-single.png)
...
```
![reduce array](/assets/images/js-array-methods/reduce-array.png)
...
```
![reduce object](/assets/images/js-array-methods/reduce-object.png)
...
```
![filter simple](/assets/images/js-array-methods/filter-simple.png)

```
object.filter(elem=>elem.present)

```
![filter simple](/assets/images/js-array-methods/filter-object.png)
...
```
![find simple](/assets/images/js-array-methods/find-simple.png)

```
object.find(elem=>elem.present)

```
![find simple](/assets/images/js-array-methods/find-object.png)
