...
author: "Feridum"
image: "/assets/images/postman/logo.jpg"
...
![get list](/assets/images/postman/GET.png)
...
![get resource with params](/assets/images/postman/GET_single.png)
...
![post new post](/assets/images/postman/POST.png)
...
![save endpoint](/assets/images/postman/save.png)
...
![environment](/assets/images/postman/environment.png)
...
![environment manage](/assets/images/postman/environment_manage.png)

Teraz musimy wpisać nazwę naszego środowiska oraz wpisać zmienne jakich chcemy używać

![environment new](/assets/images/postman/environment_new.png)
...
![environment_choose](/assets/images/postman/environment_choose.png)
...
![auth list](/assets/images/postman/auth_list.png)
...
![collection edit](/assets/images/postman/collection_edit.png)
...
![collection auth](/assets/images/postman/collection_auth.png)
