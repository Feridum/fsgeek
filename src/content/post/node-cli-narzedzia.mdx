...
author: "Feridum"
image: "/assets/images/node-cli-narzedzia/logo.jpg"
...
```
![winston basic](/assets/images/node-cli-narzedzia/winston-basic.png)
...
```
![winston format](/assets/images/node-cli-narzedzia/winston-format.png)
...
W przykładzie podałem 4 typy pytań, które możemy wykorzystać:
 ...
 ![inquirer input](/assets/images/node-cli-narzedzia/inquirer-input.png)
 - `list`- dajemy listę możliwych wartości i użytkownik wybiera jedną, 
 ![inquirer list](/assets/images/node-cli-narzedzia/inquirer-list.png)
 - `checkbox` - dajemy listę możliwości ale teraz użytkownik może wybrać więcej wartości 
 ![inquirer checkbox](/assets/images/node-cli-narzedzia/inquirer-checkbox.png)
 - `confirm`, który służy do odpowiedzi tak lub nie.
![inquirer confirm](/assets/images/node-cli-narzedzia/inquirer-confirm.png)
...
![inquirer result](/assets/images/node-cli-narzedzia/inquirer-result.png)
...
![commander](/assets/images/node-cli-narzedzia/commander.png)
...
![chalk](/assets/images/node-cli-narzedzia/chalk.png)
...
![listr waiting](/assets/images/node-cli-narzedzia/listr-waiting.png)

Tak samo w momencie gdy dostaniemy błąd to jest on wyświetlony a samo wykonywanie zadań przerwane.

![listr error](/assets/images/node-cli-narzedzia/listr-error.png)
