...
author: "Feridum"
image: "/assets/post/2021/fastify-mongo/logo.png"
...
```yaml
const { mongoPlugin } = require('/assets/post/2021/fastify-mongo/mongo.js');
...
fastify.get('/', async (req, reply) => {
  const links = await fastify.mongoDb.collection('link').find({}).toArray()  
	reply.view('/assets/post/2021/fastify-mongo/templates/main', { links });
});
```
