...
draft : false
featured : false
image : "/assets/images/node-events/logo.jpg"
menu : ""
share : true
...
![simple-event](/assets/images/node-events/simple-event.png)
...
![once-event](/assets/images/node-events/once-event.png)
...
![server-event](/assets/images/node-events/server-event.gif)
