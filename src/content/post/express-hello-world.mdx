...
author: "Feridum"
image: "/assets/images/express-hello-world/logo.jpg"
...
![express-add](/assets/images/express-hello-world/express-add.png)
...
![express-run](/assets/images/express-hello-world/express-run.png)

Znaczy to, że nasz serwer działa i możemy uruchomić naszą aplikację w przeglądarce i sprawdzić efekt:

![express-hello-world](/assets/images/express-hello-world/express-hello-world.png)
...
![express-get](/assets/images/express-hello-world/express-get.png)
![express-post](/assets/images/express-hello-world/express-post.png)
![express-put](/assets/images/express-hello-world/express-put.png)
![express-delete](/assets/images/express-hello-world/express-delete.png)
