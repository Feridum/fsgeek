...
author: "Feridum"
image: "/assets/images/angular-lifecycle/logo.jpeg"
...
![lifecycle-hooks](/assets/images/angular-lifecycle/lifecycle-hooks.png)

![lifecycle-hooks](/assets/images/angular-lifecycle/lifecycle-hooks2.png)
...
![lifecycle](/assets/images/angular-lifecycle/lifecycle.gif)

W momencie jak kliknąłem przycisk `pokaż` to został stworzony nasz komponent co widać w konsoli

![lifecycle-init](/assets/images/angular-lifecycle/lifecycle-init.png)
...
![lifecycle-init](/assets/images/angular-lifecycle/lifecycle-change.png)
