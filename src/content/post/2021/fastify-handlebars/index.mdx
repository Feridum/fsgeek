...
author: "Feridum"
image: "/assets/post/2021/fastify-handlebars/logo.png"
...
fastify.register(pointOfView, {
  ...
  layout: '/assets/post/2021/fastify-handlebars/templates/layout/layout',
})
```
...
fastify.get('/', (req, reply) => {
  reply.view('/assets/post/2021/fastify-handlebars/templates/main', {});
});
```
...
module.exports = {
  purge: [
      '/assets/post/2021/fastify-handlebars/templates/**/*.hbs'
  ],
  darkMode: false,
  theme: {
    extend: {},
