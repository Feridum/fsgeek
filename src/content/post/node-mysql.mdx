...
slug: "node-mysql"
author: "Feridum"
image: "/assets/images/node-mysql/logo.jpg"
...
![legacy-authentication](/assets/images/node-mysql/legacy.png)
...
![mysql-query](/assets/images/node-mysql/mysql-query.png)
...
![sql-injection](/assets/images/node-mysql/exploits_of_a_mom.png)
...
![mysql-query](/assets/images/node-mysql/mysql-insert.png)
