...
author: "Feridum"
image: "/assets/post/2022/architektura-react/logo.png"
...
export * from '/assets/post/2022/architektura-react/Button';

export * from '/assets/post/2022/architektura-react/Input';

export * from '/assets/post/2022/architektura-react/Select';
...
```
//Nie
import { Button } from './assets/post/2022/architektura-react/components/Button'
import { Input } from './assets/post/2022/architektura-react/components/Input'

//Tak
import { Button, Input } from './assets/post/2022/architektura-react/components'
