...
author: "Feridum"
image: "/assets/post/2021/s3-deploy/logo.png"
...
![konfiguracja nowego bucketa](/assets/post/2021/s3-deploy/nowy_bucket.png)
...
![ustawienia public bucket](/assets/post/2021/s3-deploy/public_bucket.png)
...
![upload plików](/assets/post/2021/s3-deploy/upload.png)
...
![ustawienia hostingu](/assets/post/2021/s3-deploy/hosting.png)

Pojawi się taki formularz.

![Ustawienia hostingu](/assets/post/2021/s3-deploy/ustawienia_hostingu.png)
...
![hosting url](/assets/post/2021/s3-deploy/hosting_url.png)
...
![bucket policy](/assets/post/2021/s3-deploy/bucket_policy.png)
...
![bucket policy edit](/assets/post/2021/s3-deploy/bucket_policy_edit.png)
